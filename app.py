...
for i in range(1, 11):
    ...
    LOBBY_ROOMS[room_id] = {
        "name": f"Arena {i:02d}",
        "players": [] # Lista apenas visual de nomes
    }
...
# --- CONFIGURAÇÕES DE ARQUIVOS E IA ---
...
# --- INDEXAÇÃO DAS CARTAS (OTIMIZADA) ---
if not os.path.exists(PASTA_BANCO): os.makedirs(PASTA_BANCO)

# ALTERAÇÃO 1: Reduzi nfeatures de 3000 para 1000 (3x mais rápido)
...
for arquivo in os.listdir(PASTA_BANCO):
    ...
    # ALTERAÇÃO 2: Reduzir imagem do banco se for gigante (max 600px altura)
    h, w = img.shape[:2]
...
def identificar():
    try:
        ...
        # ALTERAÇÃO 3: Reduzir imagem de entrada se for gigante (max 800px)
